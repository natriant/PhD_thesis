...
\begin{equation}\label{eq:CC_kick_sixtracklib_vertical}
    \Delta y^\prime_{j} = \cos{\left ( \phi_\mathrm{CC} \frac{\pi}{180} - \frac{2\pi f_\mathrm{CC}}{c} \frac{z \beta_0}{\beta^2} \right )} \frac{V_\mathrm{0,CC}}{p_0 c},
\end{equation}
...
In particular, in the presence of amplitude and phase noise the change of the vertical angle of each particle introduced in Eq.~\eqref{eq:CC_kick_sixtracklib_vertical} is modified as follows:
