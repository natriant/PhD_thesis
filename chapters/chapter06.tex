...
\begin{figure}[!h]
    ...
    \includegraphics[width=0.7\textwidth]{images/Ch6/study_4_AN_PN_sxitracklib.png}
        \caption{Vertical emittance growth driven by CC RF amplitude and phase as simulated with Sixtracklib simulation tool for a configuration close to the experimental conditions of the SPS CC tests 2018. The measured phase and amplitude noise spectra from Coast3-Setting3 are used for the simulations. Both types of noise are applied on CC2 which operates at 1\,MV, following Eq.~\eqref{eq:CC_kick_sixtracklib_vertical_noise}, while CC1 is switched OFF.}
...
These values were assigned to the main dipoles of the SPS and the simualtions presented in Section~\ref{sec:global_CC_sixtracklib_noiseCoast3_setting3} were repeated. The simualtions were performed in the presence of the measured phase noise spectrum only which was dominant during the SPS experiments in 2018. The results are displayed in Fig\dots
