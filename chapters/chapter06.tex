...
\begin{table}[!hbt]
   ...
   \end{centering} \footnotesize{$^\ast$ The phase advances are measured from the start of the lattice which is considered the element SPS.BWS.51995.H that is the horizontal rotational Wire Scanner.}
   \end{minipage}
\end{table}

In the longitudinal plane, the $z$ ($\delta$) co-oridnates of the particles were evenly spaced from -0.6 to 0.6\,m ($-10^{-4}$ to $10^{-4}$).
