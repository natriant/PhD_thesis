...
The simulation studies presneted in Section~\ref{subsec:fig:study_1_sixtracklib_normalised_momentum_kicks} were repeated here but this time the real $\CC$ elements were implementated and switched ON. Both $\CC$1 and $\CC2$ operated at 1\,MV, for $\phi_CC$1=90\,deg and  $\phi_CC$1=270\,deg. Figure ...
