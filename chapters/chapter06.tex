...
The benchmark with the local scheme is performed as it is closer to the case that was studied previously: where the $\CC$ RF noise is modelled as noise kicks in the transverse angle co-ordinate of the individual particles. Both configurations avoid introducing any orbit distortion from the crab cavities.
