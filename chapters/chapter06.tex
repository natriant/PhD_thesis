...
The simulation studies presneted in Section~\ref{subsec:subsec:sixtracklib_kicks_transverse_angle} were repeated here but this time the real $\CC$ elements were implementated and switched ON. Both $\CC$1 and $\CC2$ operated at 1\,MV, for $\phi_\mathrm{CC}$1=90\,deg and  $\phi_\mathrm{CC}$2=270\,deg. Figure ... visulises 
