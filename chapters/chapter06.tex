...
The simualtions were performed for both phase and amplitude $\CC$ RF noise. The noise level was chosen to be much stronger than the ones used in the experiment of 2018 in order to observe a reasonable growth in the simualtions time which was $10^5$ turns. For reference, this corresponds to about 2.5\,s in the SPS machine. Therefore, the simualtions were performed for phase and amplitude noise with power spectral density of 1.68 $10^{-10} \ \mathrm{rad^2/Hz}$ or 1/Hz (for phase and amplitude noise respectively). This corresponds to a scaling factor, $A=10^{-8}$, in Eq
