...
The amplitude and phase noise in the real $\CC$ element are modeled as the following change of the vertical angle of each particle (modyfing Eq.~\eqref{eq:CC_kick_sixtracklib_vertical}):
