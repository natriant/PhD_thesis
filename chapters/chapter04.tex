...
\begin{figure}[htp]
   ...
   \end{subfigure}
   \caption{Magnetic field of the main dipoles for the two operational configurations set up in the SPS for the emittance growth studies with CCs. \textit{Left}:}
