...
In the first configuration, the field of the main dipole magnets ramps up so that it accelerates the bunches from the injection energy of 26\,GeV up to 270\,GeV. The bunches remain at 270\,GeV for a few seconds before being dumped. After that the field of the SPS main dipole magnets returns to the initial value and the procedure is repeated.

cycle from the injection energy of 26\,GeV to 



In this section, the operational set up of the SPS machine 

The focus is put on the set u

In the usual SPS operation for the LHC filling
For the emittance growth experiments with $\CC$s in the SPS two special cycles were set up. 
