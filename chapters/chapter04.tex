...
\section{The Wire Scanners}

The SPS is equpped with rotating beam wire scanners (WS)~\cite{BOSSER1985475, Berrig:1972478} to measure the transverse beam emittance. The working prinicple is the following: a thin wire rapidly moves across the beam and a shower of secondary particles is generated, which is then detected by a system of scintillator and photomultuplier, as sketeched in Fig.~\ref{fig:SPS_WS_ROT}. 

Hence, the WS signal consists of the measured light intensity with respect to the wire position. As the wire crosses the beam over multiple turns the transverse beam profile is obtained. It is worth noting that in every passage of the beam from the WS two scans are performed with the wire moving in the forward direction (IN scan) and then backwords (OUT scan)~\cite{Dehning:895164}. An example of the WS profiles is shown in Fig.~\ref{fig:WS_example_H_profile}


\begin{figure}[!h]
   \centering         
   \includegraphics[width=0.7\textwidth]{images/Ch4/WS_sketch.png}
...
\begin{figure}
   ...
   \begin{subfigure}{.5\textwidth}
     \centering
     \includegraphics[width=1.0\linewidth]{images/Ch4/SPS.BWS.51637.H_IN scan_13Oct21_17:11:19.png}
   \end{subfigure}%
   \begin{subfigure}{.5\textwidth}
     \centering
     \includegraphics[width=1.0\linewidth]{images/Ch4/SPS.BWS.51637.H_OUT scan_13Oct21_17:11:19.png}
   \end{subfigure}
   \caption{A figure with two subfigures}
   \label{fig:WS_example_H_profile}
   \end{figure}
