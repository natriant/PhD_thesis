...
For studying the long-term emittance evolution special cycles were set up in the SPS which are called "coast" beam cycles with bunched beams. During them, the bunches circulate in the machine at constant energy for long periods, from a few minutes up to several hours, similarly to the HL-LHC case.

To make sure that the SPS machine can be used as a testbed for the emittance growth studies with $\CC$s an extensive preparatory campaign was carried out over the years 2012-2017~\cite{Calaga:1451286, Alekou_CC_coast_prep_2016, Antoniou:2649815}. The primary concern was the natural emittance growth that was observed in the machine (without noise), as it needed to be well characterized and be kept sufficiently small in order to distinguish and understand the contribution from the $\CC$ noise. From these studies, it was concluded that the optimal coast setup is at 270\,GeV, with low chromaticity and bunches of low intensity. Moreover, as the natural emittance growth was found to be a single bunch effect four bunches were used to reduce the statistical uncertainty of the measurements. 


During the experiment the Landau octupoles were switched off. Nevetherless, a residual non-linearity was present in the machine mainly due to multipole components in the dipole magnets~\cite{Carlà:2664976, Alekou:2640326}. Last, the transverse feedback system was switched off. The main machine and beam parameters of the experiment of 2018 are listed in Table~\ref{tab:machine_beam_param_2018}. It should be noted, that no measurements of chromaticity are availble from the day of the experiment. However it was ensured that it was corrected to small positive values. 
...
\begin{table}[!hbt]
   ...
   \caption{Main machine and beam parameters for the emittance growth studies with CCs in SPS in 2018}
	\begin{tabu} to \textwidth { X[c,m] X[c,m] X[c,m] X[c,m] X[c,m] X[c,m] }
		...
		\bottomrule
      \multicolumn{2}{l}{$\symE$} & \multicolumn{2}{c}{[GeV]} & \multicolumn{2}{c}{270} \\
      \multicolumn{2}{l}{$\frev$} & \multicolumn{2}{c}{[kHz]} & \multicolumn{2}{c}{43.375} \\
      \multicolumn{2}{l}{$\Nb$} & \multicolumn{2}{c}{[p/b]} & \multicolumn{2}{c}{3 $\times 10^{10}$} \\
      \multicolumn{2}{l}{bunches} & \multicolumn{2}{c}{[-]} & \multicolumn{2}{c}{4} \\
      \multicolumn{2}{l}{bunch spacing} & \multicolumn{2}{c}{[ns]} & \multicolumn{2}{c}{524} \\
      \multicolumn{2}{l}{$\fRF$ / $\VRF$} & \multicolumn{2}{c}{[MHz] / [MV]} & \multicolumn{2}{c}{200 / 3.8} \\
      \multicolumn{2}{l}{$\Qx$ / $\Qy$} & \multicolumn{2}{c}{[-]} & \multicolumn{2}{c}{26.13 / 26.18} \\
      \multicolumn{2}{l}{$\Qpx$ / $\Qpy$} & \multicolumn{2}{c}{[-]} & \multicolumn{2}{c}{ $\sim$ 1.0 / $\sim$ 1.0} \\
      \multicolumn{2}{l}{$\Qs$} & \multicolumn{2}{c}{[-]} & \multicolumn{2}{c}{0.0051} \\
