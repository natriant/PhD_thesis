...
The error bars of the uncertainty, $\Delta V_{CC}$ (left), and the phase, $\phi_{CC}$ (right), correspond to the error of the fit parameter (see Appendix~\ref{app:non_linear_fitting}). It should be noted that the error bars on the 
