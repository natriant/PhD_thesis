...
\section{The Wire Scanner}

The SPS is equpped with rotating beam wire scanners (WS) [Ref] to measure the transverse beam emittance. The working prinicple is the following: a thin wire rapidly moves across the beam and a shower of secondary particles is generated, which is then detected by a system of scintillator and photomultuplier. 

From the measured signal, which is the light intensity with respect to the wire position.

As the wire passes the beam multiple times, the beam profile is acquired 
