...
The uncertainty of the computed emittance, $\Delta \epsilon$, at a dispersion free region, depends only on the uncertainty of the measured beam size, $\Delta \sigma$, as:

\begin{equation}\label{eq:emittance_from_WS_uncertainty}
   \centering
   \frac{\Delta \epsilon_{x,y}}{\epsilon_{x,y}} = \sqrt{\left(2\frac{\Delta \sigma_{x,y}}{\sigma_{x,y}} \right)^2} = 2\frac{\Delta \sigma_{x,y}}{\sigma_{x,y}},
\end{equation}

where the relativistic parameters and the beta fucntion are considered free of error
