\vspace*{1mm}
In 2018, two prototype Crab Cavities ($\CC$s) were installed in the SPS to be tested for the first time with proton beams. This chapter discusses some of the first experimental results with $\CC$s in SPS and describes the operational setup and the developed measurement methods. The methods and procedures presented were developed at CERN. They are analyzed here for the completness of the thesis and for the better understadning of the work discussed in the following chapters.
...
\begin{table}[!hbt]
   \centering
   \caption{SPS CC parameters}
   \begin{tabular}{lc}
       \toprule
       \textbf{Parameters} & \textbf{Values}\\
       \bottomrule
       crabbing plane & vertical \\
       $\s$-location, CC1 & 6312.72\,m \\
       $\s$-location, CC2 & 6313.32\,m \\
      $\fCC$  & 400\,MHz   \\ 
      $\phiCC$  & 0\,deg   \\ 
      \bottomrule
