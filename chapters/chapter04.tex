...
The $\CC$ voltage callibration was performed by calcualting the kick required to reconstruct the intra-bunch offset measurements from the HT monitor. The formula for computing the vertical orbit shift at the HT monitor location $i$ from the $\CC$ kick $\theta$ at the location $j$ is given by~\cite{Carver:2696108, Chao:1490001}:
