...
\includegraphics[width=0.65\textwidth]{images/Ch4/HT_VCC_callibration_20180530_135105.png}
    \caption{CC voltage calibration from the HT monitor. The measured CC voltage, consideres as hlaf the peak to peak amplitue of the signal, is 0.96\,MV.}
...
CC$ voltage appears to be assumetric around $\VCC (t)$ = 0\,MV. Thus, the measured $\VCC$ is considered as half the peak to peak amplitude i.e. the difference between the positive and the negative peaks of the signal.
