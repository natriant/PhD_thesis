...
\section{Installation in the SPS}\label{sec:cc_sps_installation}
...
In case someone wants to repeat the study, the location of the $\CC$s along the SPS ring is also indicated.
