...
\vspace*{1mm}
In 2018, two prototype Crab Cavities ($\CC$s) were installed in the SPS to be tested for the first time with proton beams. A series of dedicated machine developemnt studies was carried out in order to validate their working principle and answer various beam dynamic questions. The objective of this chapter is to provide an overview of the operational setup and to describe the instrumentation and the methods deployed for the measurement of the first crabbing with proton beams. These methods and procedures were developed at CERN and they are essential for the understadning of the work discussed in the following chapters.
...
SPS recieves the beam at 26\,GeV. It was observed that if the ramp to higher energies was performed with the $\CC$ on, the beam was lost while crossing one of the vertical betatron sidebands due to resonant excitation. Therefore, it was established that the acceleration has to be performed with the $\CC$ off and its voltage must be set up only after the energy of interest has been achieved. It should be noted here that this will be the approach also for the HL-LHC~\cite{Rama_Paris_presentation}.
