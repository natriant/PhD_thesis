...
In view of the $\CC$ operation in HL-LHC where the beam will stay in the machine for sevral hours, special cycles were setup in the SPS for the emittance growth studies. They are called \enquote{coast} beam cycles with  bunched beams and during them the bunches circulate in the machine at constant energy for long periods up to a few hours.

Due to the limited available time in SPS for $\CC$ tests during 2018, the optimal machine and beam parameters for the coast cycles were identified in advance during an extensive preparatory campaign which was carried out over the years 2012-2017~\cite{Calaga:1451286, Alekou_CC_coast_prep_2016, Antoniou:2649815}.

The main issue was to define the beam energy where the studies should take place over the range of 26 GeV to 450 GeV. CC kick stronger for lower energies. 
Problem natural emittance growth in SPS. Single bunche effect (thus we can have 4 bunches for higher statistics), dependnece on chromaticity --> we need low chroma. depend on intensity (?) --> low intensity 3e10 ppb. dependence on energy to minimise it we need higher energy. Coast can be achieved at max 270 GEV/c ??.



The issue of major concern was found to be the natural emittance growth observed in both transverse planes in the SPS (without the $\CC$s) as it needed to be well understood in order to be seperated from the $\CC$ noise induced emittance growth. 
...
. One issue of major concern was the natural emittance growth in the SPS machine (without the CCs). The residual emittance growth was found to be less significant for higher energies and low chromaticity values. Therefore, in order to disentangled  from the CC noise induced emittance growth. 

270 GeV higher energy in coast
...
- 4 bunches for better statistics
