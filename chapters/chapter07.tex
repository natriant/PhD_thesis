...
The study was repeated for $\CC$ RF noise kick at 200\,MHz, i.e. $\CCfrequency=200$\,MHz, which equals the frequency of the main accelerating RF system of the SPS (see Table~\ref{tab:machine_beam_param_2018}).
...
In that case, the headtail mode 0 is more dominant than in the case of RF noise at 400\,MHz,

. The simulations were performed with and without the SPS impedance model in the presence of both amplitude and phase noise, 


The noise level was scaled such as it results in emittance growth rate similar to what was discussed previously ~ 25 nm/s.
