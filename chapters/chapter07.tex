...
\begin{itemize}
    \item The two upper spectra, where the coherent mode lies inside the incoherent spectrum, reside to the regime of no emittance growth suppression.
    \item The two middle spectra, where the coherent mode emerges from the incoherent spectrum, reside to the regime where the emittance growth suppression increases for higher intensity values.
    \item The two bottom spectra, where the cohere mode is well separated from the incoherent spectra, reside to the regime where the dependence on the intensity saturates.
\end{itemize}
...
According, to Y.~Alexahin's theory for beam-beam induced effects, the explanation is that only part of the energy from the noise kicks is absorbed by the incoherent spectrum and drives incoherent motion and leads to irreversible emittance growth. The rest of the energy is absorbed by the coherent mode, which is damped by the impedance (for the expereimental conditions of small positve chromaticity) without leading to emittance growth.
