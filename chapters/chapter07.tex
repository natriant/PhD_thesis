...
\begin{table}[!hbt]
	\begin{minipage}{\textwidth}
      \begin{centering}
   \caption{Machine and beam parameters used for simulating the emittance evolution due to CC RF noise in the presence of transverse beam impedance with PyHEADTAIL code.}
