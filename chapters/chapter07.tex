...
\begin{table}[!hbt]
   ...
   \end{centering}\footnotesize{$^\ast$ This value corresponds to the average bunch length of bunch 1 at the end of each coast. The value for bunch 1 is used here as it was the only stable bunch in the SPS $\CC$ tests of 2018. \\ $^\dagger$ Model values for the Q26 optics.}
   \end{minipage}
\end{table}
...
This parametric study was conducted for the experimental beam and machine conditions of 2018. They are also reported in Table~\ref{tab:CC_pyheadtail_simulation_parameters}. The study is repeated with and without including the effect of the wakefields. The results are summarised in Fig.~\ref{fig:study_10_bunch_length}.

\begin{figure}[!h] % cernbox/=/pyheadtail_data/final_for_thesis/2018_conditions/study_5_dipole_nois
    \centering         
    \includegraphics[width=0.7\textwidth]{images/Ch7/deyRates_sps_PN1e-8_00MHz_270GeV_wakesOFF_vs_ON_QpxQpy5e-1_Nb5e5_ayy2000_slices500_intensity3e10_sigmaScanScanZvsTheorywithoutWakes_vs_SPS_sigmaz.png}
...
the dependence of the emittance growth suppression 
