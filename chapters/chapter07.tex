...
It appears that effects from the beam coupling impedance is an important factor to be considered for such studies. The effect of the suppression of noise-induced emittance growth from the impedance has not been observed before. To this end, a series of studies were performed to characterised this effect and understand the mechanism behind it. These studies, will be addressed in the following sections.


\section{Characterisation of the emittance growth suppression by the impedance}\label{sec:}

As discussed in the previous section, PyHEADTAIL simulations showed that the transverse beam impedance (not included in the theory of P.~Baudrenghien and T.~Mastoridis~\cite{PhysRevSTAB.18.101001}) has a significant impact on the $\CC$ RF noise-induced emittance growth.



The studies were performed following the procedure described in 
