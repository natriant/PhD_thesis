...
sequaence of noise kicks represents white noise spectrum which excites the

with mean 1 and standard deviation of $10^{-8}$. In other words the standard deviation is the parameter $A$ of Eqs.~\eqref{eq:amplitude_noise_kick} and~\eqref{eq:phase_noise_kick} 
