...
The simulations were performed with the setup described in Section~\ref{sec:first_obs_suppression}. Instead of the cosine like phase noise kick a pure dipolar noise kick was applied on the beam which was modeled by the following transformation:
