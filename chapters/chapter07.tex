...
\subsection{Testing the implementation in PyHEADTAIL}
One of the most common ways to test the correct implementation of the impedance model in a tracking simualtion code is to look at its impact on the coherent behavior of a single bunch and in particular on the coherent tune.
