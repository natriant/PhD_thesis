...
Figure~\ref{fig:sps_impedance_model_H_V} shows the complete transverse impedance model of the SPS machine with the disentangled dipole (blue) and quadrupole (orange) terms to be plotted seperetaly. 
...
In order to include the impedance effects in particle tracking simulations the real-values wakefields~\cite{sps_impedance_model_git} in time domain are used. As described in Section~\ref{sec:wakefields_theory} this corresponds to the inverse Fourier transformation of the complex-valued impedance in frequency domain. The wakefunctions (dipolar and quadrupolar term) for both transverse planes are read in PyHEADTAIL from tables. 
% more details in the procedure in the thesis of Benoit


input in tables in headtail
