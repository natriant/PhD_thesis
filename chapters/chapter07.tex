...
\begin{table}[!hbt]
   ...
   \end{centering}\footnotesize{$^\ast$ This value corresponds to the average r,s measured bunch length of bunch 1 over all the coasts of 2018. The value for bunch 1 is used here as it was the only stable bunch in the SPS $\CC$ tests of 2018. \\ $^\dagger$ Model values for the Q26 optics.}
   \end{minipage}
\end{table}
