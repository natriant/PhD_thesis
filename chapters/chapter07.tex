...
As concluded in Section~\ref{sec:emittance_growth_exploratory_studies}, the effect of the emittance growth suppression from the beam coupling impedance is associated with the coherent tune shift, caused by the dipolar impedance term. This triggered the idea, that overlap between the coherent tune and the incoherent spectrum \footnote{Incoherent spectrum is defined as the set of the oscillation frequencies of the individual particles within a bunch.} could explain this observation. 
% Or: "This lead to the proposal.." instead of "triggered the idea".

The motivation for this idea,  came from the fact that past theoretical studies from Y.~Alexahin~\cite{Alexahin:314169} showed that the efficiency of the feedback system at suppressing the emittance growth depends on overlap between the frequency of the coherent mode and the incoherent spectrum. 




However, in these studies the coherent tune was shifted by beam -beam and not by impedance. 
Thus our plan was to explore this mechanism a bit more with tracking simulations. 
