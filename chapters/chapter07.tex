...
Here, the incoherent spectrum of the bunch is investigated for different intensities in an attempt to visualise and hence confirm that the suppression mechanism is a result of the separation of the coherent mode from the incoherent spectrum. The incoherent spectrum is obtained from Fourier's analysis of the turn-by-turn centroid motion. This method can be also found in the bibliography as Schottky noise method~\cite{Caspers:1213284} and is often used for beam diagnostics as it can reveal information on important parameters such as the revolution frequency, the momentum spread, and of course the incoherent spectrum.
 ...
 The results are displayed in Fig. ... which shows the vertical spectrum of the centroid (coherent) oscillation of the bunch for different intensity values, selected from the range studied in the previous subsection: ~\ref{subsec:intensity_scan_emit_growth}. Each subplot shows the power spectral density of the motion of the centroid as a function of the frequency in tune units for a given intensity value, which increases from the top left to the bottom right. The power spectral density of the motion of the centroid is obtained from the above-mentioned Fourier transform using Eq.~\eqref{eq:Sxx_definition_discrete_normalized}. Expressing the amplitude of the spectral components as power spectral density in units of $\mathrm{rad^2}/Q_y$ is preferable to display the amplitude of the spectral compoenents of the Fourier transform which is in arbitrary units.



The amplitude of the spectral compoenents is expressed 


It can be seen, that the amplitude of the spectral components is shown as power spectral 


is expressed in terms of power spectral density 



 Last, the amplitude of the spectral compo

 Fig.. shows the vertical spectrum of the centroid (coherent) oscillation of a bunch simulated with PyHEADTAIL for different intensity values. In other words, it shows the power spectral density of the motion of the centroid as a function of the frequency in tune units. The power spectral density of the motion of the centroid is obtained from the above mentioned fourier transform using Eq.~\eqref{eq:Sxx_definition_discrete_normalized}. 
 
 
 The power spectral density is computed from the 

Last, it is worth mentioning that 



The coherent betatron mode clearly emerges from the incoherent spectrum for higher intensities, at the time the emittance growth suppression starts to be visible too.

- mention how do you compute the power spectral density (is shown in the appendix)
