...
Figure~\ref{fig:study_5_dipole_noise} shows the noise-induced vertical emittance growth as a function of amplitude-dependent tune spread with and without the presence of wakefield kicks. In the absence of wakefields (blue) the emittance growth appears independent of the tune spread while for $\alpha_\mathrm{yy}=0$ zero emittance growth is observed. The latter observation is anticipated, since for zero betatron tune spread there is no decoherence and thus no emittance growth is expected.
