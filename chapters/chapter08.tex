...
The experiment lasted from about 23:50 on the May 16, 2022, until about 04:00 on the 17th of May, 2022. Even though the available machine time was $\sim$4 hours, only seven octupole strengths could be tested: $+25, +15, +10, +5, 0, -15, -7.5 \ \mathrm{1/m^4}$. The reason is that one of the SPS quadrupole magnets tripped around 01:00 disabling the option for operation in coast, till around 03:00 when the quadrupole magnet got back working.
