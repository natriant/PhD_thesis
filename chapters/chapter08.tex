...
The damper provided noise excitation in the vertical plane which remained constant over the different coasts of the experiment. The strength of the damper kick was not calibrated and therefore the analytical expected emittance growth could not be computed. However, the experimental data can be used to make qualitatively statments about the suppression mechanism from the beam transverse imepdance.  
