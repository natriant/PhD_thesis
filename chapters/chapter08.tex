...
The emittance growth measurements described in this section, were performed in coast mode at 270\,GeV following the same set up as in the May 2022 experiment and very similar machine and beam conditions. An overview of the paramters can be found in Table~\ref{tab:machine_beam_param_2022}.

Nevertheless, comparing to the May experiment, the bunch length, the $\CC$ voltage amplitude and the injected noise were measured at slightly different values and they are addressed in the following paragraphs. Finally, the linear chromaticity was corrected to $Q^\prime_{x,y}=0.65$ in both transverse planes to ensure the coherent stability of the bunch even for large negative octupole strengths\footnote{It is reminded here, that the occurance of horizontal coherent instabilities was a limiting factor in the emittance growth measurements that took place in May 2022, due to the almost zero values of linear chromaticity.}.
