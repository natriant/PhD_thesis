...
\section{Additional measurements with CC RF noise}\label{sec:cc_md_Sep2022}
Due to the very promising results of the experiments that took place in May 2022 (presented in Sections~\ref{sec:cc_md_2022} and~\ref{sec:coast_md_damper_2022}) some available time ($\sim$ 12 hours) was allocated for additional emittance growth measurements with $\CC$ RF noise on 12 September, 2022. The objective of this new round of measurements was to measure the vertical emittance growth in the presence of $\CC$ RF phase noise and strong octupoles $|k_\mathrm{LOD} | > 20$\,$\mathrm{/m^4}$ for which the suppression mechanism is expected to be disabled (see Fig.~\ref{fig:pyheadtail_cc_impedance_2022_md_octupole_current}).

The experiment presented in this section was performed for the same conditions with the one in May (see Table~\ref{tab:machine_beam_param_2022}).
