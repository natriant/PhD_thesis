...
By plotting, 
Qualitatively, the experimental data (both from May and September) are in agreement with the simulations as they reproduce the dependence on the amplitude dependent tune spread. 


The simualations, however, predict slower emittance growth than what was observed in the machine for $0 <k_\mathrm{LOD} $
...
The point at klod=10. agree in both measuremnts. is impressive.
slightly higher measured --> could explained with a 10$\%$ uncertainty ont he cc measurement or a vertical offset for sources we dont understandin. as already stated the space charge impacrt dhould be studied.  25 percent off . pas mal 
