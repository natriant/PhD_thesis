...
- it also provides an explanation for the assymetry in for negative and positive detuning coefficients observed in the pyheadtail simulations (in section 7).
...
The details of this work are presented in Refs.~\cite{Buffat:2022dac} and~\cite{van_kamper_presentation_xavier_theory}.
