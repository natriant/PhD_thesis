...
\textbf{CC RF noise}\\
The noise injected in the $\CC$ RF system was again a mixture of phase and amplitude noise, however the contribution of amplitude noise to the total emittance growth was found to be insignificant (about 6$\%$ \footnote{Further details on this analyisis are reported in the Appendix...}). Example spectra are shown in Fig... where it can be seen that the noise was applie on the first betatron sideband only.
...
The OUT scan was set after 200\,ms after the IN scan. However, there 
