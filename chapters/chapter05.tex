...
However, the $\CC$ phase that was set by the $\CC$ operators during the experiment, which will be referred to "inspector phase" throught this thesis, was $\phi_\mathrm{CC, insp}=0$. It is evident that there is a phase offset of about 20$^\circ$ between the inspector phase and the phase experienced by the beam.
