...
a) Is 9:46 a good acquisition? it is too much in the past. 
b) max or peak to peak / 2.
c) I need to choose one for the parameteric studies and then I may perform a sensitivity study using the theoretical model.
d) also then you slightly need to update the plot in chapter 4. 
