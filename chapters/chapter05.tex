...
As already mentioned, the phase noise was a mixture of phase and amplitude noise with the phase noise always being dominant. In order to make a meaningful comparison between the different levels of noise, the concept of effective phase noise is introduced: this is the phase noise level that would lead to the same emittance growth as that from both phase and amplitude noise according to the theoretical model (Chapter~\ref{Ch:CC_noise_theory}). The noise levels mentioned in the folloiwng analysis correspond to the calculated effective phase noise. % For the effective phase noise 
