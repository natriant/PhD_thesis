...
\begin{table}[!hbt]
   ...
   \caption{Phase and amplitude noise levels injected in the CC RF system for the emittance growth studies of 2018. The listed values correspond to the average PSD values over a frequency range of $\pm$ 500\,Hz around the first betatron sideband, $f_b$.}
	\begin{tabu} to \textwidth { X[c,m] X[c,m] X[c,m] X[c,m]}
      ...
      \midrule
      \multicolumn{1}{l}{Coast1-Setting1}  & \multicolumn{1}{c}{-122.6 $\pm 0.6$} & \multicolumn{1}{c}{-128.1 $\pm$ 0.6} \\
      
      \multicolumn{1}{l}{Coast1-Setting2}  & \multicolumn{1}{c}{-101.4 $\pm$ 0.8} & \multicolumn{1}{c}{-115.2 $\pm$ 0.6} \\

      \multicolumn{1}{l}{Coast2-Setting1}  & \multicolumn{1}{c}{-115.0 $\pm$ 0.8} & \multicolumn{1}{c}{-124.1 $\pm$ 0.5} \\

      \multicolumn{1}{l}{Coast2-Setting2}  & \multicolumn{1}{c}{-111.4 $\pm$ 0.6} & \multicolumn{1}{c}{-115.7 $\pm$ 0.4} \\ 

      \multicolumn{1}{l}{Coast3-Setting1}  & \multicolumn{1}{c}{-110.9 $\pm$ 0.9} & \multicolumn{1}{c}{-116.9 $\pm$ 0.4} \\

      \multicolumn{1}{l}{Coast3-Setting2} & \multicolumn{1}{c}{-106.4 $\pm$ 0.3} & \multicolumn{1}{c}{-112.9 $\pm$ 0.6} \\

      \multicolumn{1}{l}{Coast3-Setting3} & \multicolumn{1}{c}{-101.4 $\pm$ 0.7}  & \multicolumn{1}{c}{-106.9 $\pm$ 0.5} \\
      \arrayrulecolor{black}\bottomrule
...
\begin{table}[ht]
   ...
   \begin{tabular}{lccc}
       \hline
       \multicolumn{1}{c}{} & \multicolumn{3}{c}{test } \\
       \toprule
       Y&X&X&X\\
       \hline
   \end{tabular}
...
As already mentioned, the phase noise was a mixture of phase and amplitude noise with the phase noise always being dominant. % For the effective phase noise 

Figure .. provides a more clear view of the measruments presented in Fig... It displays the measured emittance growth rates for each one of the four bunches for the 




Additionally, Fig.~\ref{fig:MD5_overview_x_y} shows that the emittance growth rates are different bunch by bunch and if one looks at the legends it can be seen that bunch 1 (blue) has sytematically the smallest growth rate.
