...
\begin{table}[!hbt]
   ...
   \caption{Phase and amplitude noise levels injected in the CC RF system for the emittance growth studies of 2018. The listed values correspond to the average PSD values over a frequency range of $\pm$ 500\,Hz around the first betatron sideband, $f_b$. The calculated effective phase noise for the parameters of the first bunch are also listed.}
	\begin{tabu} to \textwidth { X[c,m] X[c,m] X[c,m] X[c,m]}
		...
		\multicolumn{1}{c}{$\mathbf{\boldsymbol{\langle \sigma_\phi \rangle}}$}  \\
		%\bottomrule
      \multicolumn{1}{c}{\textbf{[dBc/Hz]}} & 	\multicolumn{1}{c}{\textbf{[rad]}} & \multicolumn{1}{c}{\textbf{Amplitude noise}} & 	\multicolumn{1}{c}{\textbf{Effective phase noise}} \\
      \midrule
      \multicolumn{1}{c}{Coast1-Setting1}  & \multicolumn{1}{c}{-122.6 $\pm 0.6$} & \multicolumn{1}{c}{-128.1 $\pm$ 0.6} & \multicolumn{1}{c}{-121.8 $\pm$ 0.5} \\
      
      \multicolumn{1}{c}{Coast1-Setting2}  & \multicolumn{1}{c}{-101.4 $\pm$ 0.8} & \multicolumn{1}{c}{-115.2 $\pm$ 0.6} & \multicolumn{1}{c}{-101.3 $\pm$ 0.8} \\

      \multicolumn{1}{c}{Coast2-Setting1}  & \multicolumn{1}{c}{-115.0 $\pm$ 0.8} & \multicolumn{1}{c}{-124.1 $\pm$ 0.5} & \multicolumn{1}{c}{-114.6 $\pm$ 0.7} \\

      \multicolumn{1}{c}{Coast2-Setting2}  & \multicolumn{1}{c}{-111.4 $\pm$ 0.6} & \multicolumn{1}{c}{-115.7 $\pm$ 0.4} & \multicolumn{1}{c}{-110.2 $\pm$ 0.5} \\ 

      \multicolumn{1}{c}{Coast3-Setting1}  & \multicolumn{1}{c}{-110.9 $\pm$ 0.9} & \multicolumn{1}{c}{-116.9 $\pm$ 0.4} & \multicolumn{1}{c}{-110.1 $\pm$ 0.8} \\

      \multicolumn{1}{c}{Coast3-Setting2} & \multicolumn{1}{c}{-106.4 $\pm$ 0.3} & \multicolumn{1}{c}{-112.9 $\pm$ 0.6} & \multicolumn{1}{c}{-105.8 $\pm$ 0.3}\\

      \multicolumn{1}{c}{Coast3-Setting3} & \multicolumn{1}{c}{-101.4 $\pm$ 0.7}  & \multicolumn{1}{c}{-106.9 $\pm$ 0.5} & \multicolumn{1}{c}{-100.6 $\pm$ 0.6} \\
      \arrayrulecolor{black}\bottomrule
	\end{tabu}
