...
The bunch length measurements acquired with the ABWLM are shown in the third plot from the top in Fig.. The two upper plots contain the transverse emittance growth as discussed in Section~\ref{sec:MD5_overview}. This is for easier comparison of the beam evolution in the transverse and in the longitudinal plane.
...
\end{sidewaysfigure}
% dont mention about the scaling with the wall current monitor
