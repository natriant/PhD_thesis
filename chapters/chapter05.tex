...
- The uncertainty on the average bunch length values is ~ 2 percent
- The uncertainty on the beta function is 5 percent due to beta beating
- in the voltage is 0.01 percent. 
- The other paramters are free of error
...
% 3. Compute the theoretically growth rates: /eos/user/n/natriant/2018/CC_MD_2018_summary/cmpt_emit_growth_theoretical_model/job001_cmpt_theoretical_emit_growth_MD5_2018.ipynb
