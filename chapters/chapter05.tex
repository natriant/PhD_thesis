...
\end{equation}
for amplitude and phase noise, respectively. The multiplication factors 4 and 2, shows the contribution from to the first synchrobetatron and betatron sidebands at the frequencies computed in Eqs.~\eqref{eq:synchrobetatron_sideband_1} and ~\eqref{eq:betatron_sideband_1}.
...
It is reminded, that the power spectral densities $S_{\Delta A}$ and $S_{\Delta \phi}$ appear independent of the frequency since the noise spectra it is considered constant up to 10\,kHz.
