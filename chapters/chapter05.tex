...
The SPS is equipped with wire scanners (WS) to measure the transverse beam emittance. The SPS WS system is described in detail in Ref.~\cite{BOSSER1985475, Berrig:1972478}. For the SPS tests in 2018, the emittance was measured with WS both for the horizontal and vertical plane (BWS.51995.H and BWS.41677.V respectively).
...
% Note 2: Table 5.1 0.0% for 450 GeV, 0.2%. I think this is for 26 GeV, for 270 GeV the blow up would be even smaller.
% Note 3: Also "p.70 The measurements show an emittance growth of 43.5±11.8 nm per scan, which is best approximated by prediction 3)."
