...
It is reminded, that the power spectral densities $S_{\Delta A}$ and $S_{\Delta \phi}$ appear independent of the frequency since the noise spectra are considered constant up to 10\,kHz. They can be computed from the measured spectra expressed in $10\log_{10}\mathcal{L}$\,[dBc/Hz] through the relation $S_{\Delta A, \Delta \phi} = \mathcal{L}$ introduced earlier in this section.
