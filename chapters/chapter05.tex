...
The bunch length measurements acquired with the ABWLM are shown in Fig.. The two upper plots contains the transverse emittance evolution as discussed in Section~\ref{sec:MD5_overview} for easier comparison of the beam evolution in the transverse and longitudinal planes. The lower plot displays the 
