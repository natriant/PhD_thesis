...
In this section, an overview of the emittance growth measurements is presented. Figure ... displays the bunch by bunch transverse emittance evolution throught the total duration of the experiment. The three different coasts are distinguished in this plot with the blue dashed vertical lines. The values of the injected phase noise are also displayed (according to Table~\ref{tab:noise_settings_2018}), while the moments when the noise level changed are shown with the grey vertical lines. The values of phase noise only are displayed as it was dominant during the experiment. A more complete analysis including also the amplitude noise levels is discussed in the folloiwng and illustrated in Fig .... Last, the four different colors (blue, orange, red, green) correspond to the four different bunches.
