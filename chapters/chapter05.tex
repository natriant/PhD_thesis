...
The bunch length measurements acquired with the ABWLM are shown in the third plot from the top in Fig.~\ref{fig:MD5_overview_x_y_sigma_t} The two upper plots contain the transverse emittance growth as discussed in Section~\ref{sec:MD5_overview}. This is for easier comparison of the beam evolution in the transverse and in the longitudinal plane.
