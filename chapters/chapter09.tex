...
The studies in the SPS machine are very different from the HL-LHC case. Some of the main machine and beam design parameters are summarised in Table .. for the SPS and HL-LHC.


\begin{table}[!hbt]
	\begin{minipage}{\textwidth}
      \begin{centering}
   \caption{Overvirew of the design paramters for the SPS and HL-LHC. The listed values for HL-LHC case are for beams at collision energy}
