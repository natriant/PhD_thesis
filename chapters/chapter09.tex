...
Natalia’s detailed investigations have shown that in the case of crab cavity induced noise kicks, the decoherence suppression is related purely to the rigid bunch motion (headtail mode 0) of the beam. For the case of the SPS tests, this mechanism results in an emittance growt
