...
To this end, it is concluded that the mechanism of the emittance growth suppression from impedance (or beam-beam effects) due to the separation of the coherent modes from the incoherent spectrum does not appear for the HL-LHC operational configuration. The experimental observation of the effect of the suppression from the impedance in the SPS was feasible due to its operation with very small incoherent betatron tune spread. % pathological case.

% Simulation results with damper in the SPS
