This chapter introduces the concepts of accelerator beam physics which are essential for understanding the studies of this thesis. The definitions and notations are based on the book of A. Wolksi ~\ref{}, unless it is stated otherwise, where one can look for further details if needed. Additionally, in the last section, the tracking simulation codes used in this work are described too.
