...
Synchrotrons are cuircular accelerators where the accelerating particles follow a fixed closed-loop path. In a synchrotron electric fields accelerate tha particles while magnetic fields steer and focus them. The magnetic fields are not constant but they vary according to the particles' energy, allowing acceleration and operation in very high (relativistic) energies. The LHC and SPS machines at CERN are synchrotrons.  



What is a synchrotron? No interaction between bunches. First part no interaction betewen particles. and the collective effects: impedance.
