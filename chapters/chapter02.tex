...
\begin{figure}[!h] % at the directory of ipac22
    ...
    \includegraphics[width=0.8\textwidth]{images/Ch2/coordinates_particle_motion.png}
        \caption{Co-ordinate system used to describe particles motion in a synchrotron. The co-ordiante system, with $(\mathbf{e_x, e_y, e_z})$ being the unit vectors, is rotating following the reference trajectory along the accelerator.}
