...
On the other hand, the way the $\CC$ noise affects the particles depends on their longitudinal position within the bunch. In this paragraph, the modeling of dipole noise is introduced while the details on the $\CC$ noise are discussed further in a dedicated section (see Section~\ref{sec:CC_noise_intro}). 
