...
The power spectral density of these noise kicks for a white noise spectrum can be computed as follows (see discussion in Appendix~\ref{ch:app_B} and Eq.~\eqref{eq:psd_for_white_noise_variance}):
