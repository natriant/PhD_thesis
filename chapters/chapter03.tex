...
In particle accelerators, a major issue of concern is the presence of external noise. Examples of noise sources are ripples in the power converter ripples, fluctuations of the magnetic fields, ground motion, and various instruments in the accelerator structure such as the transverse damper and the Crab Cavities.

From the various noise sources that are present in an accelerator, this thesis discusses the dipolar noise and the CC noise. The majority of the noise sources produced dipolar noise, which is constant along the bunch, i.e. all the particles are affected the same way. % this noise is also referred to as rigid noise 
On the other hand the way the CC noise affects the particles depends on their longitudinal position within the bunch.

source and CC with mainly focusing on the secong.
