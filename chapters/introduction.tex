...
High-Luminosity LHC (HL-LHC)~\cite{HL_LHC_yellow_report, Brning2015} is the upgrade of the LHC machine which aims to extend its potential for discoveries. In particular, it targets to increase its instantaneous luminosity by a factor of 5 beyond the current values and the integrated luminosity by a factor of 10. 
