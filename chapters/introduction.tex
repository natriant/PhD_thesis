...
As the $\CC$s have never been used with protons before, two protoype superconducting $\CC$s were installed in the SPS (Fig.~\ref{fig:LHC_layout_CCs}, magenta) to be tested and validate their operation with proton beams before their installation in LHC. SPS consists an ideal test bed for these studies as it allows testing for the closest conditions to the LHC than any other machine (proton beams, storage ring mode, second highest beam energy after LHC).




it can provide the highest energy 


it is the only machine that allows us to simulate the closest to the conditions for the HL-LHC (energy, stored beam, protons). 
