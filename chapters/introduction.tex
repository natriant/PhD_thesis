...
Finally, simulations including the SPS transverse impedance model (not included in the theory (of Chapter 3) showed a significant impact on the emittance growth. The investigation and characterisation of the phenomenon of the emittance growth suppression as observed in simplicitions with PyHEADTAIL is discussed in details in Chapter 7.

In Chapter 8, the second round of emittance growth measurments with $\CC$s in SPS that took place in 2022 is described. The objective of these experimental studies was to validate the mechanism of the suppression of the $\CC$ RF noise-induced emittance growth from the beam coupling impedance as observed in simulations (described in Chapter 7) . The experiments successfully confiremed the suppression meachanism, despite the very challenging conditions of the studies.
