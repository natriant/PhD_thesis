...
\begin{table}[ht] % table take from the APR
    ...
    \end{tabular}
    \label{table:sps_mult_270GeV} % is used to refer this table in the text
    \end{table}
