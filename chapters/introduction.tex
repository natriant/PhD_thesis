...
A physics fill is the time period during which the beams are successfully injected in the LHC at the desired conditions, are accelerated at the desired eneegy, are kept in the machine for consectuive collisions. After some hours, due to beam degradtion the beams are damped and a new fill is prepared. A fill in the HL-LHC and lasts a couple of hours.  
(i.e. the beams have successfully been injected according to the desired filling scheme

Phyiscs fill 5-20 hours depending on the scheme that will be used.
