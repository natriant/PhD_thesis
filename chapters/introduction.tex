...
The luminosity, along with the energy, is a key parameter defining the performance of a collider as it is a measure of the collisions rate and is expressed as~\cite{luminosity}:
...
where $\frev$ is the revolution freuency of the machine, $n_b$ is the number of colliding bunch pairs, $N_{1,2}$ is the bunch intensity, $\sigma_{x,y}$ is the transverse beam size at the interaction point, $\sigma_z$ the rms bunch length, $\sigma_{\mathrm{xing}}$ the transverse beam size in the crossing plane and $\alpha$ is the full crossing anlge.





Reminder: Luministy formula ... is the collisions rates. 
instantaneoud vs integrated..





which aims to increase it instantaneous luminosity by a factor of 5 and the integrated 


Beyond the discovery of the Higgs boson (2012) LHC has the potential 


Beyond the discovery of Higgs, 
It is undergoing continuous imporovements for energy and lumnisity.


After the discovery of higgs continuous changes ... many 
