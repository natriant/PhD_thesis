...
\newcommand{\emitx}{{\epsilon_{x}}}
\newcommand{\emity}{{\epsilon_{y}}}
\newcommand{\emitxgeom}{{\epsilon_x^{geom}}}
\newcommand{\emitygeom}{{\epsilon_y^{geom}}}
\newcommand{\Dqxrms}{{\Delta\: \!Q^\mathrm{rms}_{x}}}
\newcommand{\Dqyrms}{{\Delta\: \!Q^\mathrm{rms}_{y}}}
...
\fancypagestyle{mystyle_acronyms_1}{%
    \lhead{\textbf{List of Acronyms}}
    \rhead{}
}

\fancypagestyle{mystyle_acronyms_2}{%
    \rhead{\textbf{List of Acronyms}}
    \lhead{}
}

\fancypagestyle{conclusions}{%
    \lhead{\textbf{8. Conclusions}}
    \rhead{}
}
...
\input{glossary.tex}
\thispagestyle{mystyle_acronyms_2}
