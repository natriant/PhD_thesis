...
\nomenclature[63]{$N_\mathrm{mp}$}{Number of macroparticles used in PyHEADTAIL simulations.}
\nomenclature[64]{$N_\mathrm{turns}$}{Number of turns used in PyHEADTAIL simulations.}
