...
\nomenclature[56]{$\Delta A$}{Relative devitation from the nominal amplitude of the signal or amplitude noise (no units).}
\nomenclature[57]{$\Delta \phi$}{Devitation from the nominal phase of the signal or phase noise in units of [$\mathrm{rad^2}$].}
