...
\begin{figure}[htp]
 ...
 \subsection{Experiment III: restoring the emittance growth rate predicted from Mastoridis--Baudrenghien model}\label{subsec:emit_growth_cc_md_sep2022}
 ...
 \subsection{Experiment II: restoring the emittance growth rate predicted from Mastoridis--Baudrenghien model}\label{subsec:2022_exp2_bunch_length}
...
The average measured bunch length over all above coasts in 2022, was found to be, 4$\sigma_t$=1.75\,ns. 
